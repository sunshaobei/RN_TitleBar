...
import {statusBarHeight, titleHeight, unitWidth,width} from "./AdapterUtil";
...
export default class TitleBar extends Component {
    static propTypes = {
        ...
        //     PropTypes.object,
        // ]),
        // rightImage: PropTypes.source,
        // leftImage: PropTypes.source,
                    ...
                    {this.props.hideLeftArrow ? (
                        ...
                        <TouchableOpacity activeOpacity={1} onPress={this.back.bind(this)}
                            ...
                            <Image style={TitleStyle.titleLeftImage}
                                   source={this.props.leftImage || Images.back}/>
